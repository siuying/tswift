...
// Tier 11 / Web demo — Generics: free functions with Comparable/Equatable constraints
// and generic inout swap.  (Generic struct instantiation 'Stack<Int>()' is a
// separate frontend-gap; see generics_stack.swift.)
