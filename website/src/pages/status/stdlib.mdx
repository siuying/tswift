...
<CoverageBar label="Standard Library" done={19} total={26} />

---

## Core Value Types

<CoverageBar label="Core value types" done={6} total={8} />
...
<CoverageBar label="Collections" done={4} total={5} />
...
<CoverageBar label="Key protocols" done={7} total={10} />
