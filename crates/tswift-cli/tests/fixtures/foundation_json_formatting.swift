...
enc1.outputFormatting = JSONEncoder.prettyPrinted
...
enc2.outputFormatting = JSONEncoder.sortedKeys
...
enc3.outputFormatting = [JSONEncoder.prettyPrinted, JSONEncoder.sortedKeys]
