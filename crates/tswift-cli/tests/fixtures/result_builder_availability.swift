// Result-builder availability (#129): an `if #available(…)` branch wraps its
// component in buildLimitedAvailability before the surrounding buildOptional /
// buildEither handling.
@resultBuilder
struct StringBuilder {
    ...
    static func buildLimitedAvailability(_ value: String) -> String { "avail(" + value + ")" }
}
