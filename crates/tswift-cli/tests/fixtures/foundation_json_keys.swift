...
enc1.keyEncodingStrategy = JSONEncoder.convertToSnakeCase
...
dec2.keyDecodingStrategy = JSONDecoder.convertFromSnakeCase
...
encRT.keyEncodingStrategy = JSONEncoder.convertToSnakeCase
var decRT = JSONDecoder()
decRT.keyDecodingStrategy = JSONDecoder.convertFromSnakeCase
