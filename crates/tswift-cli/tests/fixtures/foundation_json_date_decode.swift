...
dec2.dateDecodingStrategy = JSONDecoder.secondsSince1970
...
dec3.dateDecodingStrategy = JSONDecoder.millisecondsSince1970
...
dec4.dateDecodingStrategy = JSONDecoder.iso8601
...
do {
    ...
    dec5.dateDecodingStrategy = JSONDecoder.iso8601
...
dec6.dateDecodingStrategy = JSONDecoder.iso8601
...
do {
    ...
    dec7.dateDecodingStrategy = JSONDecoder.iso8601
...
do {
    ...
    dec8.dateDecodingStrategy = JSONDecoder.iso8601
...
do {
    ...
    dec9.dateDecodingStrategy = JSONDecoder.iso8601
