...
fn install_inner(interp: &mut Interpreter<'_>) {
    ...
    // `.blendMode(_:)` typed so `.overlay` resolves against `BlendMode` (the
    // bare name is ambiguous with other token namespaces, e.g. Charts'
    ...
    fn registered_keys_cover_v1_constructors() {
        ...
        assert_eq!(
            ...
            vec![
                ...
                "View.accessibilityAdjustableAction",
                ...
                "View.backgroundPreferenceValue",
                ...
                "View.digitalCrownRotation",
                "View.disableAutocorrection",
                "View.disabled",
                "View.disclosureGroupStyle",
                "View.dismissalConfirmationDialog",
                "View.draggable",
                "View.drawingGroup",
                ...
                "View.onDrop",
                "View.onDropSessionUpdated",
                "View.onExitCommand",
                "View.onGeometryChange",
                "View.onHover",
                "View.onInteractiveResizeChange",
                "View.onKeyPress",
                ...
                "View.onScrollTargetVisibilityChange",
                "View.onScrollVisibilityChange",
                "View.onSubmit",
                "View.onTapGesture",
                "View.onVolumeViewpointChange",
                "View.onWorldRecenter",
                "View.opacity",
                "View.ornament",
                "View.overlay",
                "View.overlayPreferenceValue",
                "View.padding",
                ...
                "View.presentationPreventsAppTermination",
                ...
                "View.touchBarCustomizationLabel",
